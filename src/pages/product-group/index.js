      ...
      return (
        <Default meta={meta} nav="fixed">
          ...
          <div className="container products-container">
            <h1 className="product-group-heading">Name of product group</h1>
            <hr></hr>
            <div style={{ display: "flex", marginBottom: "86px" }}>
              <div className="col-md-6 product-group-text">
                <div className="text-group">
                  With a simple turn of the key you’ll be loving the sensation
                  of utter speed as you zoom over the water. Riding a jetski is
                  easy. It is fully automatic – no clutch or gears to worry
                  about.
                </div>
                <div className="text-group">
